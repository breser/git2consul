...
// TODO: Maybe add support for BitBucket, but the POST webhook from BitBucket sends data in a format that is almost
// completely nuts, and it doesn't contain the data we need to identify branch changes.

/**
 * Register an init method for each support webhook implementation.
 */
[exports.github, exports.stash].forEach(function(hook_impl) {
