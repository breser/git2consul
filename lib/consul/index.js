...
var create_key_name = function(branch, file, ref) {
  ...
  // File naming function to convert file name according to needs
  if (branch.file_name_rule && !file.indexOf(".ref") > -1) {
    var file_name_converter = eval(branch.file_name_rule);
    file = file_name_converter(file);
  }
