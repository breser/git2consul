...
/**
 * For JSON to handle the encoding
 */
 ...
 * the diff.
 */
var populate_kvs_from_object = function(branch, prefix, obj, existing_kvs, cb, toEncode) {
  var write_kvs = [];
  var delete_kvs = [];
  var candidate_kvs = [];

  toEncode == true ?  render_encoded(candidate_kvs, prefix, obj) : render_obj(candidate_kvs, prefix, obj);
