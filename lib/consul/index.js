...
var create_key_name = function(branch, file, ref) {
  ...
  // Optionally begin with the repo name
  if (branch.include_repo_name) {
    key_parts.push(branch.repo_name);
  }
...
exports.getLastProcessedRef = function(branch, cb) {
  var key_name = create_key_name(branch, branch.name + '-' + branch.repo_name + '.ref', true);
...
exports.setLastProcessedRef = function(branch, ref, cb) {
  write_content_to_consul(create_key_name(branch, branch.name + '-' + branch.repo_name + '.ref', true), ref, cb);
};
