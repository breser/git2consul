...
function Branch(repo_config, name) {
  ...
  Object.defineProperty(this, 'include_repo_name', {
    // If include_repo_name is not set, assume true.  Otherwise, identity check the value against true.
    value: repo_config['include_repo_name'] == undefined || repo_config['include_repo_name'] === true
  });
